...
function GenerateMercadoLibreJSON(data: any): MercadoLibre {
  ...
  return {
    ...
    mercado_libre_seller_reputation_ratings_positive: data.seller_reputation.transactions.ratings.positive,
    mercado_libre_seller_reputation_ratings_negative: data.seller_reputation.transactions.ratings.negative,
    mercado_libre_seller_reputation_ratings_neutral: data.seller_reputation.transactions.ratings.neutral,
    mercado_libre_buyer_reputation_canceled_transactions: data.buyer_reputation.transactions.canceled.total,
